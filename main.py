...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if len(user_text) == 3 and user_text.isalpha():
        ...
        if rate:
            ...
            await update.message.reply_text(
                f"❌ មិនបានរកឃើញ '{user_text}'។ សូមប្រើ /usd_khmer, /eur_usd, /gbp_usd"
            )
    else:
        await update.message.reply_text(
            "សូមប្រើពាក្យបញ្ជា:\n/usd_khmer\n/eur_usd\n/gbp_usd\n/help"
...
def main():
    ...
    # တည်ဆောက် Application សម្រាប់ python-telegram-bot v20+
    ...
    # ចាប់ផ្តើម Bot តាមរយៈ Polling យ៉ាងត្រឹមត្រូវ
