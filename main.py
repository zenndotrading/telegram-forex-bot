...
# Token បន្ទាប់ពី Environment Variable
TOKEN = os.getenv("8628436926:AAGSF0m1cxSjspRlr1V_vnPmS7UwM_IaPvI
")
...
# ដឹក Message ផ្សេងទៀត
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_text = update.message.text.upper()
    
    # ប្រើប្រាស់ currency codes ដូចជា USD, EUR, GBP, etc.
